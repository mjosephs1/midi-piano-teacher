...
class MainWindow(QMainWindow):
    ...
    def _go_to_find_chord(self):
        ...
        self._find_chord.activate(self._find_chord_mode.group_enabled, self._find_chord_mode.sharps_enabled)
    ...
    def _go_to_find_chord_timed(self):
        ...
        self._find_chord_timed.activate(self._find_chord_mode.group_enabled, self._find_chord_mode.sharps_enabled)
